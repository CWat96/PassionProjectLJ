...
public class StoneGemResource {
    ...
    public ResponseEntity<StoneGem> updateStoneGem(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, stoneGem.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<StoneGem> partialUpdateStoneGem(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, stoneGem.getId().toString())
        );
    }
     ...
     */
    @GetMapping("")
    public List<StoneGem> getAllStoneGems() {
    ...
    public ResponseEntity<StoneGem> getStoneGem(@PathVariable("id") Long id) {
        ...
        Optional<StoneGem> stoneGem = stoneGemRepository.findById(id);
