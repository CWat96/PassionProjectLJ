...
public class PlatingMaterialResource {
    ...
    public ResponseEntity<PlatingMaterial> updatePlatingMaterial(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, platingMaterial.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PlatingMaterial> partialUpdatePlatingMaterial(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, platingMaterial.getId().toString())
        );
    }
    ...
    public List<PlatingMaterial> getAllPlatingMaterials(
        ...
        if (eagerload) {
            return platingMaterialRepository.findAllWithEagerRelationships();
        } else {
    ...
    public ResponseEntity<PlatingMaterial> getPlatingMaterial(@PathVariable("id") Long id) {
        ...
        Optional<PlatingMaterial> platingMaterial = platingMaterialRepository.findOneWithEagerRelationships(id);
