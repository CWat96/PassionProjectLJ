...
public class MaterialSideEffectsResource {
    ...
    public ResponseEntity<MaterialSideEffects> updateMaterialSideEffects(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, materialSideEffects.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<MaterialSideEffects> partialUpdateMaterialSideEffects(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, materialSideEffects.getId().toString())
        );
    }
