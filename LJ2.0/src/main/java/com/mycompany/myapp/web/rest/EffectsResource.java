...
public class EffectsResource {
    ...
    public ResponseEntity<Effects> updateEffects(@PathVariable(value = "id", required = false) final Long id, @RequestBody Effects effects)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, effects.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Effects> partialUpdateEffects(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, effects.getId().toString())
        );
    }
     ...
     */
    @GetMapping("")
    public List<Effects> getAllEffects(@RequestParam(name = "eagerload", required = false, defaultValue = "true") boolean eagerload) {
        log.debug("REST request to get all Effects");
        if (eagerload) {
            return effectsRepository.findAllWithEagerRelationships();
        } else {
    ...
    public ResponseEntity<Effects> getEffects(@PathVariable("id") Long id) {
        ...
        Optional<Effects> effects = effectsRepository.findOneWithEagerRelationships(id);
